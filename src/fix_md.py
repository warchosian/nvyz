...
# 🔗 Import du resolver glob (depuis src/core/pathglob.py ou utils/pathglob.py)
try:
    from src.core.pathglob import resolve_path_patterns
except ImportError:
    try:
        ...
        from pathglob import resolve_path_patterns
